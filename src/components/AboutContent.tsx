  ...
  return (
    <PageShell>
      ...
      <div className="flex flex-col gap-5">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-20px" }} variants={item}>
          <h3 className="text-[13px] font-medium text-[#0d1124] dark:text-[#dde0f0] mb-3">
            In so few words
          </h3>
          <p className="text-[13px] leading-[1.85] text-[#5a6280] dark:text-[#6b7090] mb-4">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-20px" }} variants={item} className="mt-4">
          <h3 className="text-[13px] font-medium text-[#0d1124] dark:text-[#dde0f0] mb-3">
            Somewhere beyond
          </h3>
          <p className="text-[13px] leading-[1.85] text-[#5a6280] dark:text-[#6b7090] mb-4">
